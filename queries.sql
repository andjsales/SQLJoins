...
SELECT o.first_name, o.last_name, COUNT(v) as count FROM owners o
JOIN vehicles v ON o.id = v.owner_id
GROUP BY o.id 
...
SELECT o.first_name, o.last_name, AVG(v.price) AS average_price, COUNT(v.id) AS count FROM owners o
JOIN vehicles v ON o.id = v.owner_id
GROUP BY o.id
